...
const KpiHeaderCards = () => {
  return (
    <div className='grid grid-cols-4 gap-4 max-h-[calc(100svh-100px)] flex-1 overflow-y-scroll'>
      ...
      {/* KPI Card 3 */}
      <div className='p-3 rounded-2xl flex flex-col  justify-between border dark:bg-gradient-to-br dark:from-neutral-700/30 dark:to-netural-800/40 dark:backdrop-blur-2xl'>
        <div className=''>
          <div className='flex items-center justify-between'>
            <p className='font-semibold text-muted-foreground'>Utilization(km)</p>
            <HoverCard>
            <HoverCardTrigger asChild>
          ...
          <div className='flex justify-between items-start'>
            ...
            <DonutChart percentage={75} color={'#F59E0B'} width={90} height={60} thickness={10} />
      ...
      {/* KPI Card 4 */}
      <div className='p-3 flex flex-col justify-between rounded-2xl border dark:bg-gradient-to-br dark:from-neutral-700/30 dark:to-netural-800/40 dark:backdrop-blur-2xl'>
        <div>
          <div className='flex items-center justify-between'>
            ...
            <HoverCardContent className="w-80">
              <div className="flex justify-between gap-4">
                <div className="space-y-1">
                  ...
                  <p className='text-sm   tracking-tight mb-1'>
                    Truck 8074-BGB shows 22% higher spoilage risk this trip.
                  </p>
                  <p className='text-sm   tracking-tight mb-1'>
                    Humidity spike detected in Truck 8446-BGB cargo freshness may drop in 6 hrs.
                  </p>
                </div>
              </div>
            </HoverCardContent>
        ...
        <div>
          <HoverCard>
            <HoverCardTrigger asChild>
              <div className='w-full flex items-center mt-4 gap-1'>
                <div className='h-5 w-[70%] bg-[#10B981] rounded-tl-sm rounded-bl-sm flex items-center justify-center text-white font-bold text-shadow'>
                  14
                </div>
                <div className='h-5 w-[20%] bg-amber-400 flex items-center justify-center text-white font-bold text-shadow'>
                  4
                </div>
                <div className="h-5 w-[10%] bg-red-400 rounded-tr-sm rounded-br-sm flex items-center justify-center text-white font-bold text-shadow">
                  2
                </div>
              </div>
            </HoverCardTrigger>
            <HoverCardContent>
              <div className='rounded-lg flex flex-wrap gap-2'>
                <div className='flex items-center gap-2'>
                  ...
                  <p className='  text-xs font-bold ml-auto flex items-center gap-1 dark:text-[#e2e2e2]'>14</p>
                </div>
        ...
        <div className='mt-2 rounded-lg flex items-center justify-center flex-wrap gap-2'>
            <div className='flex items-center gap-2'>
              <div className='h-2 w-2 rounded-full bg-[#10B981]'></div>
