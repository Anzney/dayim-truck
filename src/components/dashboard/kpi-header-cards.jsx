  ...
  return (
    <div className='grid grid-cols-2 gap-4'>
      <div className='p-4 rounded-2xl border dark:bg-gradient-to-br dark:from-neutral-700/30 dark:to-netural-800/40 dark:backdrop-blur-2xl'>
        ...
        <p className='text-4xl space-y-1.5 tabular-nums font-mono font-bold dark:text-[#e2e2e2] '>24</p>
      ...
      <div className='p-4 rounded-2xl border dark:bg-gradient-to-br dark:from-neutral-700/30 dark:to-netural-800/40 dark:backdrop-blur-2xl'>
        ...
        <div className='w-full flex items-center mt-4 gap-1'>
          <div className='h-5 w-[70%] bg-emerald-400 rounded-tl-sm rounded-bl-sm'></div>
          <div className='h-5 w-[20%] bg-amber-400'></div>
          <div className="h-5 w-[10%] bg-red-400 rounded-tr-sm rounded-br-sm"></div>
        </div>
