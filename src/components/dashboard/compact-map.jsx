...
const CompactMap = () => {
  ...
  const updateMapView = useCallback((validVehicles) => {
      ...
      <div className='p-4 border-gray-200 dark:border-gray-700'>
        ...
        {/* <div className='flex items-center gap-4 text-xs'>
          ...
          <div className='flex items-center gap-1'>
            ...
            <span className='text-muted-foreground'>Idle: {statusCounts.idle}</span>
          </div>
          <div className='flex items-center gap-1'>
            <div className='w-2 h-2 rounded-full bg-red-500'></div>
            <span className='text-muted-foreground'>Stopped: {statusCounts.stopped}</span>
          </div>
          <div className='flex items-center gap-1'>
            <div className='w-2 h-2 rounded-full bg-gray-500'></div>
            <span className='text-muted-foreground'>Offline: {statusCounts.offline}</span>
          </div>
        </div> */}
      </div>
