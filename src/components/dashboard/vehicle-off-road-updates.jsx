...
const VehicleOffRoadUpdates = () => {
  return (
    <div className='border rounded-2xl p-3 h-[62vh] flex flex-col dark:bg-gradient-to-br dark:from-neutral-700/30 dark:to-neutral-800/40 dark:backdrop-blur-2xl'>
      {/* Header */}
      ...
      <div className='flex flex-col gap-3 overflow-y-auto flex-1 min-h-0'>
        {offRoadIncidents.map((incident) => (
          <div 
            key={incident.id}
            className={`border-l-2 rounded-lg rounded-l-none p-3 transition-all duration-200 cursor-pointer ${getStatusColor(incident.status)}`}
          >
            {/* Main Content Row */}
